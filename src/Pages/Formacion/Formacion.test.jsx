...
import Etapa from './Components/Etapa.test'
...
const Formacion = () => {
  const Estudios = [
    {
      ...
      skills: ['Metodologias Agiles', 'Estructuras de proyectos'],
    },
    {
      year: '2021-2022',
      place: 'UNSAM',
    ...
    },
    {
      ...
      skills: [
        'CRM',
        'Estudios de Mercado/Economicos/Financieros',
        'Maquetización de piezas[Inventor]',
      ],
    },
    {
      year: '2013-2017',
  ...
  const Experiencias = [
    ...
    },
    {
      ...
      skills: ['HTML', 'CSS', 'JavaScripts', 'PHP'],
    },
    {
      year: '2014-2017',
    ...
    <>
      ...
      <div className="row">
        <div className="col-12 col-sm-12 col-lg-8">
          ...
          {Estudios.map(
            ({ year, description, place, title, skills }, index) => (
              <Etapa
                year={year}
                place={place}
                title={title}
      ...
      <div className="row">
        <div className="col-12 col-sm-12 col-lg-8">
          ...
          {Experiencias.map(
            ({ year, title, place, description, skills }, index) => (
              <Etapa
                year={year}
                place={place}
                title={title}
